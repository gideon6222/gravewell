...
## which assigned EVERY user argument to `_seconds`. `float("shop")` is 0.0, so
## the two-argument form photographed the TITLE FRAME and still exited 0 with a
## plausible-looking PNG. First numeric argument is the seconds, first
